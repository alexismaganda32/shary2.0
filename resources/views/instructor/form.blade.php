		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<span class="elipsis">
						<strong ng-bind="textAction">CREAR</strong> <strong>INSTRUCTOR</strong>
					</span>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
				            ...
				            <div class="form-group">
			                    ...
			                    <input type="number" class="form-control" ng-model="data.telephone">
				            </div>
						</div>
					</div>
